...
import cn.playscala.mongo.codecs.macrocodecs.{CaseClassCodec, ModelRegistryMacro, CaseClassProvider}
 ...
 * ```
 * import org.mongodb.scala.bson.cn.playscala.mongo.codecs.Macros.createCodecProvider
 * import org.bson.cn.playscala.mongo.codecs.configuration.CodecRegistries.{fromRegistries, fromProviders}
 *
