...
package cn.playscala.mongo.json.codecs.macrocodecs

import cn.playscala.mongo.json.annotations.BsonProperty
  ...
  def createCodec[T: c.WeakTypeTag](c: whitebox.Context)(codecRegistry: c.Expr[CodecRegistry], encodeNone: c.Expr[Boolean]): c.Expr[Codec[T]] = {
    ...
    c.Expr[Codec[T]](
      q"""
        ...
        import org.bson.codecs.configuration.CodecRegistry
        import cn.playscala.mongo.json.codecs.macrocodecs.MacroCodec
