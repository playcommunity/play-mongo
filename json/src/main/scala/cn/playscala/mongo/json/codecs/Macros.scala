...
import cn.playscala.mongo.json.codecs.macrocodecs.{CaseClassCodec, CaseClassProvider}
 ...
 * ```
 * import org.mongodb.scala.bson.cn.playscala.mongo.json.codecs.Macros.createCodecProvider
 * import org.bson.cn.playscala.mongo.json.codecs.configuration.CodecRegistries.{fromRegistries, fromProviders}
 *
